...
namespace Musk_Inspections
{
    ...
    
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SumInterventions = total1 + pages.HSQE.sumInterventions;
            ...
            string newWordFilePath = Path.Combine(fpWord, "MuskReport.docx");

            string filePath = Dashboard.Directories.dirPDFfile;
            filePath = Path.Combine(filePath, "test.pdf");
            //SaveFile(filePath);                                   // Path needs fixing
            //intoDatabase();
        ...
        private void intoDatabase()
        {
            ...
            using (SqlConnection cn = GetConnection())
            {
                ...
                */
                ...
                cmd.Parameters.Add("@Date",SqlDbType.Date).Value = pages.HSQE.datePicked; //inspectionHSQE.datePicked
